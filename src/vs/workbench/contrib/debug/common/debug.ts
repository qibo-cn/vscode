...
export const CONTEXT_TRANSFORM_STATE = new RawContextKey<string>('transformState', 'inactive');
...
export const CONTEXT_TRANSFORM_AVAILABLE = new RawContextKey<boolean>('transformAvailable', false);
